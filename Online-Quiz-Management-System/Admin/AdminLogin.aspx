<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminLogin.aspx.cs" Inherits="Views_Admin_AdminLogin" %>
            ...
            <div class="row">
                ...
                <div class="col-md-4 bg-light rounded-3 mt-4 shadow-lg">
                    ...
                    <div class="mb-3">
                        ...
                        <asp:TextBox ID="EmailTb" runat="server" CssClass="form-control" autocomplete="off" />
                    ...
                    <div class="mb-3 form-check">
                        <label class="form-check-label"><a class="text-danger" href="../Login.aspx">Login</a></label>
                    </div>
                    <div class="mb-3 d-grid">
                        <asp:Label ID="ErrMsg" runat="server" CssClass="text-danger" Text=""></asp:Label>
                        <asp:Button ID="LoginBtn" runat="server" Text="Login" 
                              class="btn btn-danger btn-block" onclick="LoginBtn_Click" />
                    </div>
                </div>
                <div class="col-md-4"></div>
            </div>
